            ...
            <form action="{{ route('itemupdate') }}" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="item_name" value="{{ $item->item_name }}" autofocus required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="measure_id" class="form-control select2" style="width: 100% !important;">
                            ...
                            <option value="{{ $unit->measure_unit_id }}" {{ $unit->measure_unit_id == $item->measure_unit_id ? 'selected' : '' }}>
                                {{ $unit->unit }}
                            </option>
                            @endforeach
                        </select>
