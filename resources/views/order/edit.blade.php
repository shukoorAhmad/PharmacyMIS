                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" value="{{ $order->order_date }}" name="order_date"
                                autocomplete="off" data-date-format="yyyy-m-d" data-provide="datepicker"
                    ...
                    @foreach ($order->order_items as $key => $ord)
                        ...
                        <div class="row">
                                ...
                                <select name="old_item[]" class="form-control select2">
                                    @foreach ($items as $item)
                                        <option value="{{ $item->item_id }}"
                                            {{ $item->item_id == $ord->items_details->item_id ? 'selected' : '' }}>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control" name="old_quantity[]"
                                    value="{{ $ord->quantity }}">
                            </div>
                            <div class="col-md-2">
                                <a href="{{ route('delete-order-item', $ord->order_item_id) }}" class="btn btn-danger w-100 delete-order-item"
                                    style="padding: 7px 1.75rem !important;margin-top:30px !important;font-size:14px !important;">
