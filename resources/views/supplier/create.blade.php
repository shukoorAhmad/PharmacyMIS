            ...
            <form method="POST" action="{{route('supplierstore')}}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control  @error('supplier_name') is-invalid @enderror" name="supplier_name" value="{{old('supplier_name')}}" placeholder="Write Supplier Name Here..." autofocus required>
                        @error('supplier_name')
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control  @error('email') is-invalid @enderror" name="email" value="{{old('email')}}" placeholder="Write Supplier Email Here...">
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong> {{$message}} </strong>
                        </span>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control  @error('contact_no') is-invalid @enderror" name="contact_no" value="{{old('contact_no')}}" placeholder="Write Contact No Here...">
                        @error('contact_no')
                        <span class="invalid-feedback" role="alert">
                            <strong> {{$message}} </strong>
                        </span>
            ...
            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$s->email}}</td>
                        <td>{{$s->contact_no}}</td>
                        <th><a data-id="{{$s->supplier_id}}" class="edit"><i class="zmdi zmdi-edit btn btn-info btn-circle"></i></a></th>
                    </tr>
                    @endforeach
                </tbody>
            </table>
