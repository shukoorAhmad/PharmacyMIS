                    ...
                    <div class="middle-box">
                        <div class="card" style="background-color: #88aacc !important;">
                            <div class="card-body p-4">
                                <!-- Logo -->
                                <h4 class="font-24 mb-30 text-white">Login.</h4>

                                <form method="POST" action="{{ route('login') }}">
                                    @csrf
                                    <div class="form-group">
                                        <input id="email" type="email" class="form-control login @error('email') is-invalid @enderror" name="email" placeholder="Enter Your Email Here" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                        @error('email')
                                    ...
                                    <div class="form-group">
                                        <input id="password" type="password" class="form-control login @error('password') is-invalid @enderror" placeholder="Enter Your Password Here" name="password" required autocomplete="current-password">
                                        @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong> {{$message }}</strong>
                                        </span>
