...
@section('content')
    ...
    <div class="bg-white" style="padding: 5rem 6rem 0.5rem 6rem;">
        <div class="container">
            <h3 class="text-uppercase">Mahboob Subhan Waisy</h3>
        </div>
    </div>
    <div class="w-100 bg-white">
        <div class="w-100 d-flex align-items-center" style="background-color: #f5f6f5; height:2.5rem; color: #000; padding: 0 6rem;">
            <div class="container d-flex justify-content-start w-100">
                <div class="d-flex align-items-center">
                    ...
                    <strong class="pl-3 pr-3 font-weight-light">mahboob.waisy@gmail.com</strong>
                </div>
                <div class="d-flex align-items-center">
                    <div style="background-color: #e0e0e0;width: 1.8rem;height: 1.8rem;text-align: center;border-radius: 1rem;font-size: 1rem;padding: 3px;">
                        <center class="zmdi zmdi-phone"></center>
                    </div>
                    <strong class="pl-3 pr-3 font-weight-light">(+93) 747-162-092</strong>
                </div>
                <div class="d-flex align-items-center">
                    <div style="background-color: #e0e0e0;width: 1.8rem;height: 1.8rem;text-align: center;border-radius: 1rem;font-size: 1rem;padding: 3px;">
        ...
        <p style="padding: 2rem 7rem; color: #000; text-align: justify;">Dear Hiring Manager,<br><br>
            I appreciate the chance to apply for the position of <b>Web Developer</b> at your company. After reading your job description, it is obvious that you're searching for a candidate who is well-versed in the duties connected with the position and is capable of carrying them out with assurance. I am certain that I possess the skills necessary to successfully complete the job competently and perform above expectations in light of these requirements. <br><br>
            I am quality-driven and have a degree from <b>Gawharshad University (4.0 GPA, Bachelor of Computer Science)</b>. I was able to gain close to 5 years of job experience during my academic career. In my spare time, I had the pleasure of working at <b>Entire Thinkers Technology, Code Zone ICT Solution, Ibtekar Paitakht ICT Solution</b> as a <b>Full Stack & Website database designer and developer</b>, where I was able to learn and advance important professional skills which I metion above
        </p>
        <div style="display:flex; padding: 0 7rem; color: #000; justify-content:space-between;">
            <ul>
                ...
                <li><span class="zmdi zmdi-mail-send"></span>&nbsp; JAVA (PL)</li>
                <li><span class="zmdi zmdi-mail-send"></span>&nbsp; C# (PL)</li>
            ...
            <ul>
                ...
                <li><span class="zmdi zmdi-mail-send"></span>&nbsp; CSS & Libraries</li>
            </ul>
            <ul>
                <li><span class="zmdi zmdi-mail-send"></span>&nbsp; Laravel (PHP Framework)</li>
                <li><span class="zmdi zmdi-mail-send"></span>&nbsp; JavaScript</li>
                <li><span class="zmdi zmdi-mail-send"></span>&nbsp; Angular & React JS</li>
